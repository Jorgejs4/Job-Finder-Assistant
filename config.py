...
# 0 = analizar todas las ofertas que sobrevivan a deduplicación y filtros.
MAX_JOBS_FOR_AI_ANALYSIS = int(os.getenv("MAX_JOBS_FOR_AI_ANALYSIS", "0"))
...
GEMINI_RATE_LIMIT_ANALYSIS = float(os.getenv("GEMINI_RATE_LIMIT_ANALYSIS", "12"))
